...
import { ArrowLeftIcon, PencilIcon, CalendarDaysIcon } from "@heroicons/react/24/outline"; // CalendarDaysIconを追加
      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-12">
          <div className="max-w-md mx-auto">
            ...
            <div className="mt-8 text-center">
                <Link href={`/habit/${habit.id}/calendar`} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
